...
- **A forced leaf goes to M11's rest pose**, like a removed one; the rest strip is not checked (M11's own open item stands) — a couch shoved from west of x 2.15 at the kitchen door would find its leaf laid under its leading corner and the solver separates them. At the door's centre the strip is 25 mm clear.
